    ...
    <div class="row">
        ...
        <div class="col-6">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="card-img" style="background-image: url('<?php echo e($post->img ? asset($post->img) : asset('img/image.png')); ?>')"></div>
...
<?php echo $__env->make('layouts.layout', ['title' => 'Главная страница'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\KILLERFICHA_\Desktop\MyFiles\Codes\Laravel\laravel9\resources\views/posts/index.blade.php ENDPATH**/ ?>