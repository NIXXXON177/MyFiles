    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="card-img card-img__max" style="background-image: url('<?php echo e($post->img ? asset($post->img) : asset("img/image.png")); ?>')"></div>
                    <div class="card-descr">Описание: <?php echo $post->descr; ?></div>
...
<?php echo $__env->make('layouts.layout', ['title' => "Пост №$post->post_id $post->title"], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\KILLERFICHA_\Desktop\MyFiles\Codes\Laravel\laravel9\resources\views/posts/show.blade.php ENDPATH**/ ?>